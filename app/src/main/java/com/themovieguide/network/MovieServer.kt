...
interface MovieServer {
    ...
    fun getMoviesData(@Path("mediaType") mediaType: String, @Path("type") movieType : String, @Query("page") moviePage : Int,
    @Query("with_original_language") originalLang : String = "") : Call<Movies>
